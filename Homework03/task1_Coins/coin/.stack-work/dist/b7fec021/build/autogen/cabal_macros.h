...
/* package coin-0.1.0.0 */
#define VERSION_coin "0.1.0.0"
#define MIN_VERSION_coin(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "coin-0.1.0.0-B5zXSSJmLk7Lb6NlVq7XjN"

#define CURRENT_PACKAGE_KEY "coin-0.1.0.0-B5zXSSJmLk7Lb6NlVq7XjN"

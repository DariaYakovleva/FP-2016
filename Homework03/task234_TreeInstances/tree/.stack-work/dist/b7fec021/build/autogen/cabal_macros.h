...
/* package tree-0.1.0.0 */
#define VERSION_tree "0.1.0.0"
#define MIN_VERSION_tree(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "tree-0.1.0.0-JpsvyQa6nxvD4Ud8cPg3VY"

#define CURRENT_PACKAGE_KEY "tree-0.1.0.0-JpsvyQa6nxvD4Ud8cPg3VY"
